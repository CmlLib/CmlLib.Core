...
public class InstallerTest
{
    ...
    public async Task TestFabric()
    {
        ...
        var launcher = new CMLauncher(path, Program.HttpClient);
        launcher.FileChanged += Downloader_ChangeFile;
        launcher.ProgressChanged += Downloader_ChangeProgress;

        // initialize fabric version loader
        var fabricVersionLoader = new FabricVersionLoader(Program.HttpClient);
        ...
        await fabric.SaveVersionAsync(path);
    ...
    public async Task TestLiteLoader()
    {
        ...
        var liteLoaderVersionLoader = new LiteLoaderVersionLoader(Program.HttpClient);
